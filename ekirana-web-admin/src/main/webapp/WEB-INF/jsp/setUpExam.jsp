...
<head>
	...
	<link rel="stylesheet" href="<%= application.getContextPath() %>/static/css/common.css?version=0.0.3">
...
<div>
	...
	<div class="clients-container">
		<ul>
			<li>
				<a href="#viewPaper"> View Papers </a>
			</li>
			<li>
				<a href="#addExam"> Add Exam </a>
			</li>
			<li>
				<a href="#setupExam"> Setup Exam </a>
			</li>
				<li>
				<a href="#setupPaper"> Setup Paper </a>
			</li>
		</ul>
	...
	<div id="static" class="sel-client-body selClient-div clients-container">
